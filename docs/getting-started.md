...
which can be downloaded as a tarball from GitHub (here we use release `0.12.0` but be sure to use the [latest CLI release](https://github.com/mainflux/mainflux/releases)):

```bash
wget -O- https://github.com/mainflux/mainflux/releases/download/0.12.0/mainflux-cli_0.12.0_linux-amd64.tar.gz | tar xvz -C $GOBIN
```
